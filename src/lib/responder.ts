...
// ---------- code verification + rate limiting (used by /api/responder) ----------

// in-memory limiter, single instance only. Move to Postgres/Upstash if this scales past one lambda.
...
// ---------- self-serve org application pipeline: apply -> admin review -> code ----------
...
// Allocates a globally unique "PREFIX-1234" code, mirroring allocateDialCode in voice.ts.
